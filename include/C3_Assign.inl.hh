...
template< class Destination, class Source >
inline Destination& C3::Detail::fill_assign( Destination& dest, const Source& src, const typename Destination::size_type count )
{
...
template< class Destination, class Source >
inline Destination& C3::Detail::copy_assign( Destination& dest, const Source& src, const typename Destination::size_type count )
{
    typename Destination::value_type* begin = dest.begin();
