...
namespace C3
{
    ...
    // Pixel-fill assignment kernel.

    template< class T, class U >
    inline void pixel_fill_assign_kernel( T* dest_begin, T* dest_end, const U src )
    {
        std::fill( dest_begin, dest_end, src );
    }

    // Block-copy assignment kernel.

    template< class T, class U >
    inline void block_copy_assign_kernel( const T* src_begin, const T* src_end, U* dest_begin )
    {
            ...
            const size_type offset, const size_type length, const size_type count, const size_type stride )
    {
        ...
        {
            pixel_fill_assign_kernel( dest_begin, dest_end, src );
            dest_begin += stride;
            dest_end   += stride;
        }
    }
            ...
            const size_type offset, const size_type length, const size_type stride )
    {
        ...
        {
            pixel_fill_assign_kernel( dest_begin, dest_end, *pixel );
            dest_begin += stride;
            dest_end   += stride;
        }
    }
            ...
            const size_type dest_offset, const size_type dest_count, const size_type dest_stride )
    {
        ...
        {
            block_copy_assign_kernel( src_begin, src_end, dest_begin );
    ...
    {
        pixel_fill_assign( dest.block(), src, 0, dest.block().size(), 1, 0 );
        return dest;
    }
    ...
    {
        pixel_fill_assign( dest.block(), src, dest.offset(), dest.ncolumns(), dest.nrows(), dest.stride() );
        return dest;
    }
    ...
    {
        block_fill_assign( dest.block(), src.block(), 0, dest.nrows(), dest.nrows() );
        return dest;
    }
    ...
    {
        block_fill_assign( dest.block(), src.block(), dest.offset, dest.nrows(), dest.stride() );
        return dest;
    }
    ...
    inline Stack< T >& assign( Stack< T >& dest, const Column< U >& src )
    {
        ...
        block_fill_assign( dest.block(), src.block(), 0, length, length );
        return dest;
    }
    ...
    {
        block_fill_assign( dest.block(), src.block(), 0, dest.nframes(), dest.nframes() );
        return dest;
    }
    ...
    {
        block_copy_assign( dest, src, 0, src.size(), 0, 0, 1, 0 );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), 0, src.block().size(), 0, 0, 1, 0 );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), src.offset(), src.ncolumns(), src.stride(), dest.offset(), dest.nrows(), dest.stride() );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), 0, src.ncolumns(), src.ncolumns(), dest.offset(), dest.nrows(), dest.stride() );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), src.offset(), src.ncolumns(), src.stride(), 0, dest.nrows(), dest.ncolumns() );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), 0, src.ncolumns(), 0, 0, dest.nrows(), dest.ncolumns() );
        return dest;
    }
    ...
    {
        block_copy_assign( dest.block(), src.block(), 0, src.ncolumns(), 0, dest.offset(), dest.nrows(), dest.stride() );
        return dest;
    }
    ...
    {
        nested_assign( dest.block(), src.block(), src.offset(), src.ncolumns(), src.stride(), 0, dest.nframes(), dest.nframes(), dest.nrows() );
        return dest;
    }
    ...
    {
        nested_assign( dest.block(), src.block(), 0, src.ncolumns(), 0, 0, dest.nframes(), dest.nframes(), dest.nrows() );
        return dest;
    }
