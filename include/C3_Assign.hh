...
namespace C3
{
    ...
    namespace Detail
    {
        ...
        template< class Destination, class Source > 
        Destination& fill_assign( Destination& dest, const Source& src, const typename Destination::size_type count );

        /// Assign repeated copies of source to destination.
        template< class Destination, class Source > 
        Destination& copy_assign( Destination& dest, const Source& src, const typename Destination::size_type count );
