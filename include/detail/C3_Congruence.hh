...
namespace C3
{
    ...
    namespace detail
    {
        ...
        {
            static const bool container_and_pixel = ContainerPairTraits< T, U >::container_and_pixel;
            using type = typename std::conditional< container_and_pixel, PixelCongruence, UndefinedType >::type;
        };
